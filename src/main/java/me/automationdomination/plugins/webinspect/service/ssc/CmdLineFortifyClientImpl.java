...
public class CmdLineFortifyClientImpl implements SscServer {
    ...
    public boolean uploadFpr(File fprScanFile, String projectVersionId) {
        String[] command = {fortifyClient, "uploadFPR", "-machineoutput", "-file", fprScanFile.getAbsolutePath(), "-projectVersionID", projectVersionId,
        ...
        logger.info(fortifyClient + "FPR File" + fprScanFile.getAbsolutePath() + "Project Version ID " + projectVersionId + "Token " + sscToken + "URL " + sscUrl);
        return true;
